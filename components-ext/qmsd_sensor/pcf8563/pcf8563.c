...
void PCF8563_SetClkout(rtc_clkout_freq_t frq) {
    if (frq == RTC_CLKOUT_FREQ_NONE) {
        I2CWriteByte(0x0d, 0x00);
    } else {
        I2CWriteByte(0x0d, frq | 0x80);
    }
}
